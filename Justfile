...
# Justfile for excel-economic-numbers-tool
...
doctor:
    @echo "Running diagnostics for excel-economic-numbers-tool..."
...
tour:
    @echo "=== excel-economic-numbers-tool Tour ==="
    @echo ""
...
help-me:
    @echo "=== excel-economic-numbers-tool Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/excel-economic-numbers-tool/issues/new"
    @echo ""
...
# LLM context dump
llm-context:
    @echo "Project: excel-economic-numbers-tool"
