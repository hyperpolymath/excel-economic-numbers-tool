{
  description = "excel-economic-numbers-tool - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 excel-economic-numbers-tool development environment"
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          pname = "excel-economic-numbers-tool";
          version = "0.1.0";
          src = ./.;
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P excel-economic-numbers-tool.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/excel-economic-numbers-tool $out/bin/  # Rust
            # cp bin/excel-economic-numbers-tool $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/excel-economic-numbers-tool";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-excel-economic-numbers-tool" {
