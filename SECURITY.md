...
Replace all {{PLACEHOLDER}} values with your information:
  Excel Economic Numbers Tool     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  excel-economic-numbers-tool             - Repository name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/excel-economic-numbers-tool/security/advisories/new)
...
- This repository (`hyperpolymath/excel-economic-numbers-tool`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/excel-economic-numbers-tool/security/advisories)
...
When using Excel Economic Numbers Tool, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/excel-economic-numbers-tool/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/excel-economic-numbers-tool/security/advisories/new) or 6759885+hyperpolymath@users.noreply.github.com |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/excel-economic-numbers-tool/discussions) |
...
*Thank you for helping keep Excel Economic Numbers Tool and its users safe.* 🛡️
